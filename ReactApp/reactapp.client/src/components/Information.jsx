...
/**
 * Information component for rendering a information and the steps involved in calculation.
        ...
        <Container fluid className={styles.infoContainer}>
            <Row className={styles.infoDiv}>
                ...
                <p className={styles.p}>Are you seeking a deeper understanding of the emissions generated by your Azure IaaS resources? <br />
                    Perhaps you&apos;re interested in comparing estimated emissions across various resources. 
                    This calculator <br /> is designed to provide valuable insights, enabling you to make informed 
                    choices and identify <br /> the most suitable solutions. Additionally, it can highlight significant contributors, <br /> 
